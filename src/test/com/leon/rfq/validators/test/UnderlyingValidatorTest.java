...
public class UnderlyingValidatorTest extends AbstractJUnit4SpringContextTests
{
	...
	{
		// Arrange
		UnderlyingDetailImpl underlying = new UnderlyingDetailImpl("testRic", "test description", BigDecimal.TEN, BigDecimal.ONE, BigDecimal.ONE, BigDecimal.ONE, true, "testUser");
	...
	{
		// Arrange
		UnderlyingDetailImpl underlying = new UnderlyingDetailImpl("testRic", "", BigDecimal.TEN,  BigDecimal.ONE, BigDecimal.ONE, BigDecimal.ONE, true, "testUser");
	...
	{
		// Arrange
		UnderlyingDetailImpl underlying = new UnderlyingDetailImpl("012345678901234567890", "test description" , BigDecimal.TEN, BigDecimal.ONE, BigDecimal.ONE, BigDecimal.ONE, true, "testUser");
	...
	public void Underlying_DescriptionTooLong_ShouldBeInvalidated()
	{
		...
		UnderlyingDetailImpl underlying = new UnderlyingDetailImpl("testRic",
				"012345678901234567890123456789012345678901234567890", BigDecimal.TEN,  BigDecimal.ONE, BigDecimal.ONE, BigDecimal.ONE, true, "testUser");
