...
public class UnderlyingDaoImplTest extends AbstractJUnit4SpringContextTests
{
    ...
    public void getAll_ValidScenario_ReturnsValidListOfAllUnderlyings()
	{
		...
		this.underlyingDao.insert("testRic", "description", BigDecimal.TEN, BigDecimal.ONE, BigDecimal.ONE,
			BigDecimal.ONE, true, "me");
	...
	{
		assertNotNull("insert method should insert a valid underlying and return it", this.underlyingDao.insert("testRic", "description",
	...
	{
		this.underlyingDao.insert("testRic", "description", BigDecimal.TEN, BigDecimal.ONE,
			BigDecimal.ONE, BigDecimal.ONE, true, "me");
		assertNull("second insert should return false because ric already exists", this.underlyingDao.insert("testRic", "description",
			BigDecimal.TEN, BigDecimal.ONE, BigDecimal.ONE, BigDecimal.ONE, true, "me"));
	}
